...
import '../../Models/sub_collections_model.dart';
...
class _AddSubCollectionState extends State<AddSubCollection> {
  ...
  Future<void> addCategory(SubCollectionsModel categoriesModel) async {
              ...
              firestoreImage == ''
                  ? SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: null,
                          child: const Text('Add a new sub collection').tr()))
                  : SizedBox(
                      height: 50,
                      child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                          ...
                          onPressed: () {
                            if (subCollection != '' &&
                                collection != '' &&
                                category != '') {
                              addCategory(SubCollectionsModel(
                                      category: category,
