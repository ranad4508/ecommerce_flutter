...
import 'package:admin_web_app/Models/categories.dart';
...
class CategoriessData extends StatefulWidget {
  const CategoriessData({super.key});
...
class _CategoriessDataState extends State<CategoriessData> {
  ...
  List<CategoriesModel> categoriesFilter = [];
  ...
  getCategory() {
    ...
    FirebaseFirestore.instance
      ...
      for (var element in event.docs) {
        var cat = CategoriesModel.fromMap(element, element.id);
        setState(() {
          categories.add(cat);
        });
      }
