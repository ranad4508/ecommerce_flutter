...
class HotDealsDatatable extends StatefulWidget {
  const HotDealsDatatable({super.key});

  @override
  State<HotDealsDatatable> createState() => _HotDealsDatatableState();
}

class _HotDealsDatatableState extends State<HotDealsDatatable> {
  bool isLoaded = false;
  ...
  void initState() {
    getCurrencySymbol();
    getProducts();
    //  yourStream = FirebaseFirestore.instance.collection('Hot Deals').snapshots();
    super.initState();
  }
