          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: Container(
                ...
                height: widget.orderModel2.status == 'Completed' ? 250 : 200,
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(
                    children: [
                      ...
                      Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // if (userID == cartModel.vendorId) const Gap(10),
                              ...
                              //             .tr()),
                              //   ),
                              // if (userID == cartModel.vendorId) const Gap(12),
                              // if (userID == cartModel.vendorId)
                              //   const Text(
                              //     'Your Product',
